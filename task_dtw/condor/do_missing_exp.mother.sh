...
# seed
matlab -r "out_file = ['/u/yichao/warp/condor_data/task_dtw/condor/do_missing_exp/TRACE_NAME.TRACE_OPT.CLUST_METHOD.cNUM_CLUST.WARP_METHOD.WARP_OPT.RANK_OPT.elemELEM_FRAC.lrLOSS_RATE.ELEM_MODE.LOSS_MODE.BURST_SIZE.INIT_ESTI_METHOD.FINAL_ESTI_METHOD.sSEED.txt']; if(exist(out_file)), exit; end; [mae] = do_missing_exp('TRACE_NAME', 'TRACE_OPT', 'RANK_OPT', ELEM_FRAC, LOSS_RATE, 'ELEM_MODE', 'LOSS_MODE', BURST_SIZE, 'INIT_ESTI_METHOD', 'FINAL_ESTI_METHOD', NUM_CLUST, 'CLUST_METHOD', 'WARP_METHOD', 'WARP_OPT', SEED); exit;"
